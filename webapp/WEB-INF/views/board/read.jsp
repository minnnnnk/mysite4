				...
				<div id="board">
					<div id="read">
						<form action="#" method="get">
							...
							<!-- 내용 -->
							<div id="txt-content">
								<span class="form-value">${bVo.content }
								</span>
							</div>

							<c:if test="${authUser.no == bVo.userNo}"><a id="btn_modify" href="${pageContext.request.contextPath}/board/modifyForm?no=${bVo.no}">수정</a></c:if>
