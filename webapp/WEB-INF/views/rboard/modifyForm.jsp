				...
				<div id="board">
					<div id="modifyForm">
						<form action="${pageContext.request.contextPath}/rboard/modify" method="get">
							<input type ="text" name="no" value="${rVo.no}">
							<!-- 작성자 -->
							...
							<!-- 제목 -->
							<div class="form-group">
								<label class="form-text" for="txt-title">제목</label> <input type="text" id="txt-title" name="title" value="${rVo.title}">
							</div>
							...
							<!-- 내용 -->
							<div class="form-group">
								<textarea id="txt-content" name="content">${rVo.content}</textarea>
							</div>
