						...
						<table id="guestAdd">
							...
							<tbody>
								...
								<tr class="button-area">
									<td colspan="4" class="text-center"><button type="submit" id="submit">등록</button></td>
								</tr>
							</tbody>
	...
	$.ajax({
		...
		success : function(gList){
			...
			for(var i=0; i<gList.length;i++){
				render(gList[i],"down")	//vo --> 화면에 그린다.
			}
...
function render(guestbookVo, opt){
	...
	str += '			<td><button class="btnDelete" data-no="'+guestbookVo.no+'">삭제</button></td>';
	str += '		</tr>';
	str += '		<tr>';
